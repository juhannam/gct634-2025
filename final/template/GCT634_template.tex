% -----------------------------------------------
% Template for KAIST GCT634 Final report
...
% Title.
% ------
\title{Paper Template For KAIST GCT634}
...
This template includes all the information about formatting manuscripts for KAIST GCT634.
